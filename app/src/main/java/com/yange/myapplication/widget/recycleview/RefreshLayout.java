package com.yange.myapplication.widget.recycleview;
...
public class RefreshLayout extends ViewGroup {
    private static final String LOG_TAG = RefreshLayout.class
            .getSimpleName();
    ...
    private final Animation.AnimationListener mReturnToHeaderPositionListener = new BaseAnimationListener() {
        @Override
        public void onAnimationEnd(Animation animation) {
            // Once the target content has returned to its start position, reset
            // the target offset to 0
    ...
    public RefreshLayout(Context context, AttributeSet attrs) {
        ...
        frameAnim = (AnimationDrawable) mHeaderView.findViewById(R.id.refresh_progress).getBackground();

        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, getResources().getDisplayMetrics()));
        addView(mHeaderView, -1, params);
    ...
    /**
     * set the viewGroup can be refreshed
     *
     * @param enabled true refresh，false Not refreshable
     */
