...
public class PinEntryEditText extends AppCompatEditText {
    ...
    protected ITextChangeListener mTextChangeListener = null;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int colorFocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.day_dde9f8);
        mColors[1] = colorFocused;

        int colorUnfocused = isInEditMode() ? Color.GRAY : ContextCompat.getColor(context, R.color.day_dde9f8);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(mHasError) {
            ...
            paint.setColor(Color.parseColor("#ea5454"));
            paint.setAntiAlias(true);
            paint.setTextSize(getResources().getDimensionPixelOffset(R.dimen.dp12));
            canvas.drawText(
    ...
    protected void onTextChanged(CharSequence text, final int start, int lengthBefore, final int lengthAfter) {
        ...
        if (mTextChangeListener != null) {
            mTextChangeListener.textChange(text);
        }
        ...
        if (getText().length() == mMaxLength && mOnPinEnteredListener != null) {
            va.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (mTextChangeListener != null) {
                        mTextChangeListener.textChange(getText());
                    }
                }
    ...
    public interface ITextChangeListener {
        void textChange(CharSequence str);
    }
