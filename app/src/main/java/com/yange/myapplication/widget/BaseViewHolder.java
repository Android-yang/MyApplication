...
import com.yange.myapplication.utils.rx.PastAwareOperatorThrottleFirst;
import com.yange.myapplication.utils.rx.RxView;
import com.yange.myapplication.widget.BaseQuickAdapter;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder addOnClickListener(@IdRes final int viewId) {
        ...
        if (view != null) {
            ...
            RxView.Companion.clicks(view)
                    .lift(new PastAwareOperatorThrottleFirst(500L, TimeUnit.MILLISECONDS))
